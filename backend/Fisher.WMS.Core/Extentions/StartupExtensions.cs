...
using Fisher.WMS.Core.Swagger;
using Fisher.WMS.Core.JWT;
using Newtonsoft.Json;
using Microsoft.AspNetCore.Cors.Infrastructure;
using Fisher.WMS.Core.Middleware;
...
namespace Fisher.WMS.Core.Extentions
{
    public static class StartupExtensions
    {
        public static void AddExtensionsService(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddDbContextPool<SqlDBContext>(t =>
            {
                ...
                {
                    t.UseSqlite(SqlLite_connection, b => b.MigrationsAssembly("Fisher.WMS"));
                }
            ...
            }).ConfigureApiBehaviorOptions(o =>
            {
              ...
              }).AddDataAnnotationsLocalization(options =>
              {
                  options.DataAnnotationLocalizerProvider = (type, factory) =>
                      factory.Create(typeof(Fisher.WMS.Core.MultiLanguage));
              }); ;
        ...
        public static void UseExtensionsConfigure(this IApplicationBuilder app, IWebHostEnvironment env, IServiceProvider serviceProvider, IConfiguration configuration)
        {
            ...
            app.UseRouting();
            app.UseMiddleware<Fisher.WMS.Core.Middleware.CorsMiddleware>();
        ...
        private static void AddSwaggerService(this IServiceCollection services, IConfiguration configuration, string BaseDirectory)
        {
            ...
            if (settings != null && settings.Name.Equals("Fisher.WMS"))
            {
        ...
        private static void UseSwaggerConfigure(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            if (swaggerSettings != null && swaggerSettings["Name"].Equals("Fisher.WMS"))
            {
                app.UseSwagger();
                ...
                app.UseSwaggerUI(c =>
                {
                    ...
                    c.IndexStream = () => Assembly.GetExecutingAssembly().GetManifestResourceStream("Fisher.WMS.Core.Swagger.index.html");
                    c.RoutePrefix = "";
        ...
        private static IServiceCollection RegisterAssembly(this IServiceCollection services)
        {
            ...
            var referencedAssemblies = System.IO.Directory.GetFiles(path, "Fisher.WMS*.dll").Select(Assembly.LoadFrom).ToArray();
